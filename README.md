...
- **Transacting privately**: Built-in privacy using [stealth addresses](https://vitalik.eth.limo/general/2023/01/20/stealth.html) and [confidential transactions](https://ethereum-magicians.org/t/eip-7945-confidential-transactions-supported-token/23586).
